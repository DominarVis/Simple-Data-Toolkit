...
@:expose
@:nativeGen
class JavaInfoArrayOfArrays extends JavaInfoAbstract {
  private function new() {
    super();
  }

  public static var instance : CodeInfo = new JavaInfoArrayOfArrays();
  ...
  public override function rowStart(name : String, index : Int) : String {
    return arrayRowStart(name, index) + arrayStart();
  }
