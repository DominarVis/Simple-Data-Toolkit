...
@:expose
@:nativeGen
class JavaInfoMapOfMapsLegacy extends JavaInfoAbstract {
  private function new() {
    super();
  }

  public static var instance : CodeInfo = new JavaInfoMapOfMapsLegacy();
