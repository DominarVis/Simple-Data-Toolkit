...
@:nativeGen
class DataTableRowReaderDecorator extends DataTableRowReader {
    private var _reader : DataTableRowReader;
    ...
    public function reuse(reader : DataTableRowReader) : Void {
        _reader = reader;
        _index = -1;
        _started = false;
        _value = null;        
    ...
    public function reader() : DataTableRowReader {
        return _reader;
    }
