...
@:expose
@:nativeGen
class JavaInfoAbstract implements CodeInfo {
  ...
  private function mapStartLegacy() : String {
    return "new java.util.HashMap<String, String>() {{";
  }

  public function mapEndLegacy() : String {
    return "}};";
  }  
  ...
  public function mapRowEndLegacy() : String {
    return "}}";
  }
  ...
  private function mapRowStartLegacy(name : String, index : Int) : String {
    if (name != null && name != "") {
      return "put(\"" + name + "\", ";
    } else {
      return "put(" + index + ", ";
  ...
  private function mapIntEntryLegacy(data : Int, name : String, index : Int) {
    if (name != null && name != "") {
  ...
  private function mapBoolEntryLegacy(data : Bool, name : String, index : Int) {
    if (name != null && name != "") {
      return "put(\"" + name + "\", " + data + ")";
    } else {
      return "put(" + index + ", " + data + ")";
  ...
  private function mapFloatEntryLegacy(data : Float, name : String, index : Int) {
    if (name != null && name != "") {
      return "put(\"" + name + "\", " + data + ")";
    } else {
      return "put(" + index + ", " + data + ")";
  ...
  private function mapOtherEntryLegacy(data : String, name : String, index : Int) {
    if (name != null && name != "") {
      return "put(\"" + name + "\", \"" + data + "\")";
    } else {
      return "put(" + index + ", \"" + data + "\")";
  ...
  private function mapNullEntryLegacy(name : String, index : Int) {
    if (name != null && name != "") {
